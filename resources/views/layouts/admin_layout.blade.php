      ...
      <ul class="sidebar-menu">
        ...
        <li>
          <a href="/administrator/news">
            <i class="fa fa-feed"></i> <span>Period</span>
          </a>
        </li>
        <li>
          <a href="/administrator/promotions">
            <i class="fa fa-tag"></i> <span>Class</span>
          </a>
        </li>
        <li>
          <a href="/administrator/tours">
            <i class="fa fa-map"></i> <span>Course</span>
          </a>
        </li>
        <li>
          <a href="/administrator/video">
            <i class="fa fa-video-camera"></i> <span>Present</span>
          </a>
        </li>
        ...
        <li>
          <a href="/administrator/admin">
            <i class="fa fa-user-secret"></i> <span>Students</span>
          </a>
        </li>
      </ul>
    </section>
